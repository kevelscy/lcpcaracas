  ...
  <section className='w-full flex flex-col justify-center items-center md:flex-row' style={{ minHeight: '85vh' }}>
    {
      resources.map(resource => (
        <Link href={resource.to} key={resource.to}>
          <a className='resourceLinkWrapper'>
            <figure key={resource.label} className='resourceImgWrapper'>
              <Image src={resource.img} placeholder='blur' objectFit='cover' className='w-full' alt={resource.label} />
